...
function instantiateMetricsRogueAp(location, value, errors) {
	if (type(value) == "object") {
		...
		function parseInterval(location, value, errors) {
			if (type(value) in [ "int", "double" ]) {
				if (value > 1440)
					push(errors, [ location, "must be lower than or equal to 1440" ]);
					...
					function parseItem(location, value, errors) {
						...
						function parseVariant1(location, value, errors) {
							if (type(value) == "object") {
								...
								function parseBssid(location, value, errors) {
									if (type(value) == "string") {
										if (!match(value, regexp("^([0-9a-fA-F]{2}:){5}[0-9a-fA-F]{2}$")))
											push(errors, [ location, "must match regular expression /^([0-9a-fA-F]{2}:){5}[0-9a-fA-F]{2}$/" ]);
