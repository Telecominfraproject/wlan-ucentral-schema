...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/services/airtime_fairness.uc", context);
...
function main() {
	printf("=== Airtime Fairness Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("airtime-fairness-basic", "input/airtime-fairness-basic.json", "output/airtime-fairness-basic.uci");
	run_test("airtime-fairness-custom", "input/airtime-fairness-custom.json", "output/airtime-fairness-custom.uci");
	run_test("airtime-fairness-disabled", "input/airtime-fairness-disabled.json", "output/airtime-fairness-disabled.uci");
	...
	printf("All Airtime Fairness service tests passed!\n");
}
