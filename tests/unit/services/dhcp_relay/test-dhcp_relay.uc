...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/services/dhcp_relay.uc", context);
...
function main() {
	printf("=== DHCP Relay Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("dhcp_relay-basic", "input/dhcp_relay-basic.json", "output/dhcp_relay-basic.uci");
	run_test("dhcp_relay-no-service", "input/dhcp_relay-no-service.json", "output/dhcp_relay-no-service.uci");
	run_test("dhcp_relay-no-config", "input/dhcp_relay-no-config.json", "output/dhcp_relay-no-config.uci");
	run_test("dhcp_relay-no-interfaces", "input/dhcp_relay-no-interfaces.json", "output/dhcp_relay-no-interfaces.uci");
	...
	printf("All DHCP Relay service tests passed!\n");
}
