...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/services/online_check.uc", context);
...
function main() {
	printf("=== Online Check Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("online-check-ping-only", "input/online-check-ping-only.json", "output/online-check-ping-only.uci");
	run_test("online-check-download-only", "input/online-check-download-only.json", "output/online-check-download-only.uci");
	run_test("online-check-combined", "input/online-check-combined.json", "output/online-check-combined.uci");
	run_test("online-check-disabled", "input/online-check-disabled.json", "output/online-check-disabled.uci");
	...
	printf("All Online Check service tests passed!\n");
}
