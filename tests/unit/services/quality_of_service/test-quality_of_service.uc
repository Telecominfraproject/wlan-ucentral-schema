...
function main() {
	printf("=== Quality of Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("qos-basic", "input/qos-basic.json", "output/qos-basic.uci");
	run_test("qos-services", "input/qos-services.json", "output/qos-services.uci");
	run_test("qos-complex", "input/qos-complex.json", "output/qos-complex.uci");
	run_test("qos-disabled", "input/qos-disabled.json", "output/qos-disabled.uci");
	...
	printf("All Quality of Service tests passed!\n");
}
