...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/services/dhcp_snooping.uc", context);
...
function main() {
	printf("=== DHCP Snooping Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("dhcp-snooping-basic", "input/dhcp-snooping-basic.json", "output/dhcp-snooping-basic.uci");
	run_test("dhcp-snooping-upstream-downstream", "input/dhcp-snooping-upstream-downstream.json", "output/dhcp-snooping-upstream-downstream.uci");
	run_test("dhcp-snooping-vlans", "input/dhcp-snooping-vlans.json", "output/dhcp-snooping-vlans.uci");
	...
	printf("All DHCP Snooping service tests passed!\n");
}
