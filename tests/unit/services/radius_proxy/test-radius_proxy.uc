...
function main() {
	printf("=== RADIUS Proxy Service Template Tests ===\n\n");
	
	// Run all test cases
	run_test("radius-proxy-radsec", "input/radius-proxy-radsec.json", "output/radius-proxy-radsec.uci");
	run_test("radius-proxy-radius", "input/radius-proxy-radius.json", "output/radius-proxy-radius.uci");
	run_test("radius-proxy-block", "input/radius-proxy-block.json", "output/radius-proxy-block.uci");
	run_test("radius-proxy-mixed", "input/radius-proxy-mixed.json", "output/radius-proxy-mixed.uci");
	run_test("radius-proxy-disabled", "input/radius-proxy-disabled.json", "output/radius-proxy-disabled.uci");
	...
	printf("All RADIUS Proxy service tests passed!\n");
}
