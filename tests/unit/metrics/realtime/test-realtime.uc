...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/metric/realtime.uc", context);
...
function main() {
	printf("=== Realtime Metrics Template Tests ===\n\n");
	
	// Run all test cases
	run_test("realtime-basic", "input/realtime-basic.json", "output/realtime-basic.uci");
	run_test("realtime-no-config", "input/realtime-no-config.json", "output/realtime-no-config.uci");
	run_test("realtime-empty-types", "input/realtime-empty-types.json", "output/realtime-empty-types.uci");
	run_test("realtime-filtered-events", "input/realtime-filtered-events.json", "output/realtime-filtered-events.uci");
	...
	printf("All realtime metrics tests passed!\n");
}
