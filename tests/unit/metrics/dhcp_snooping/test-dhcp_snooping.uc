...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/metric/dhcp_snooping.uc", context);
...
function main() {
	printf("=== DHCP Snooping Metrics Template Tests ===\n\n");
	
	// Run all test cases
	run_test("dhcp-snooping-basic", "input/dhcp-snooping-basic.json", "output/dhcp-snooping-basic.uci");
	run_test("dhcp-snooping-no-service", "input/dhcp-snooping-no-service.json", "output/dhcp-snooping-no-service.uci");
	run_test("dhcp-snooping-all-filters", "input/dhcp-snooping-all-filters.json", "output/dhcp-snooping-all-filters.uci");
	run_test("dhcp-snooping-multiple-interfaces", "input/dhcp-snooping-multiple-interfaces.json", "output/dhcp-snooping-multiple-interfaces.uci");
	run_test("dhcp-snooping-single-filter", "input/dhcp-snooping-single-filter.json", "output/dhcp-snooping-single-filter.uci");
	...
	printf("All DHCP snooping metrics tests passed!\n");
}
