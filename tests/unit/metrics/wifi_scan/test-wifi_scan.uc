...
function run_test(test_name, input_file, expected_file) {
	...
	try {
		...
		// Render template
		let output = render("../../../../renderer/templates/metric/wifi_scan.uc", context);
...
function main() {
	printf("=== WiFi Scan Metrics Template Tests ===\n\n");
	
	// Run all test cases
	run_test("wifi-scan-basic", "input/wifi-scan-basic.json", "output/wifi-scan-basic.uci");
	run_test("wifi-scan-no-config", "input/wifi-scan-no-config.json", "output/wifi-scan-no-config.uci");
	run_test("wifi-scan-all-enabled", "input/wifi-scan-all-enabled.json", "output/wifi-scan-all-enabled.uci");
	run_test("wifi-scan-all-disabled", "input/wifi-scan-all-disabled.json", "output/wifi-scan-all-disabled.uci");
	run_test("wifi-scan-minimal", "input/wifi-scan-minimal.json", "output/wifi-scan-minimal.uci");
	...
	printf("All wifi_scan metrics tests passed!\n");
}
